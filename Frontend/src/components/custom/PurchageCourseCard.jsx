  ...
  return (
    <div className="group w-full max-w-sm rounded-xl border bg-white p-3 transition-all hover:shadow-lg">
      ...
      <div className="relative overflow-hidden rounded-lg bg-[#FFF4E8]">
        <img
          src="https://d3njjcbhbojbot.cloudfront.net/api/utilities/v1/imageproxy/https://images.ctfassets.net/00atxywtfxvd/5rYF1dB5rQdD8Ude60Vcgk/a64d122febc9a54ee56402dd3d012042/Data_Scientist-hero_2x.png?auto=format%2Ccompress&dpr=2&w=720"
      ...
      <div className="space-y-2 px-1 pt-3">
        ...
        <div className="flex items-center justify-between pt-2 ">
          <Button
            variant="outline"
            onClick={() => navigate("/get-started/course/learning/courseid")}
...
export default PurchageCourseCard;
