    ...
    children: [
      {
        ...
        children: [
          ...
          {
            path: "courses/course-details/:courseId/session-create/",
            element: <AdminSessionCreate />,
          },
          {
            path: "courses/course-details/:courseId/session-create/live-video",
            element: <CourseSessionLive />,
          },
          {
            path: "courses/course-details/:courseId/session-create/recorded-video",
            element: <CourseSessionRecorded />,
          },
        ],
      },
    ],
